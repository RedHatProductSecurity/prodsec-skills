...
| `module/skills/` | 142 production skills — flat directories, each with `SKILL.md` and optional `reference/` |
...
Skills are grouped logically by `category` and `subcategory` fields in each `SKILL.md`. Counts by category: **114** secure development, **18** security testing, **6** security auditing, **4** developer tooling — see [`docs/skills-index.md`](docs/skills-index.md).
