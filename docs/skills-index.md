...
127 production-ready skills. All skills are tool-agnostic markdown — they work with Claude Code, Cursor, Copilot, or any assistant that can read files.
...
| [`security_testing/`](#security_testing) | 6 | Finding vulnerabilities — fuzzing and static analysis |
...
### `security_testing/fuzzing/` — 1 skill
