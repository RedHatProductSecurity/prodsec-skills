...
- Check for placeholder credential values — look for obvious default strings
  (e.g., `changeme`, `development`, `test`) assigned to fields like
  `password`, `api_key`, or `secret_key`
