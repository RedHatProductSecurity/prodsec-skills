...
## Report template (`results.md`)

Start the report from this structure (do not add sections beyond those below):
...
1. Creating a `.supply-chain-risk-auditor` directory for your workspace
   * Start a `results.md` report file using the report template above
...
**NOTE:** Do not add sections beyond those noted in the report template above.
