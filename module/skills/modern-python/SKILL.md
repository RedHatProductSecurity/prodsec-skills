...
│   └─ Use PEP 723 inline metadata (see upstream Trail of Bits prodsec-skills for companion files)
│
...
| **prek** | Pre-commit hooks (see upstream Trail of Bits prodsec-skills for companion files) | pre-commit (faster, Rust-native) |
...
For security hook configuration and usage, see upstream Trail of Bits prodsec-skills for companion files (`modern-python/references/security-setup.md`).
...
See pyproject.md (see upstream Trail of Bits prodsec-skills for companion files) for complete configuration reference.
...
**For standalone scripts**: Convert to PEP 723 inline metadata (see pep723-scripts.md (see upstream Trail of Bits prodsec-skills for companion files))
...
4. Add ruff configuration (see ruff-config.md (see upstream Trail of Bits prodsec-skills for companion files))
...
See uv-commands.md (see upstream Trail of Bits prodsec-skills for companion files) for complete reference.
...
- migration-checklist.md (see upstream Trail of Bits prodsec-skills for companion files) - Step-by-step migration cleanup
- pyproject.md (see upstream Trail of Bits prodsec-skills for companion files) - Complete pyproject.toml reference
- uv-commands.md (see upstream Trail of Bits prodsec-skills for companion files) - uv command reference
- ruff-config.md (see upstream Trail of Bits prodsec-skills for companion files) - Ruff linting/formatting configuration
- testing.md (see upstream Trail of Bits prodsec-skills for companion files) - pytest and coverage setup
- pep723-scripts.md (see upstream Trail of Bits prodsec-skills for companion files) - PEP 723 inline script metadata
- prek.md (see upstream Trail of Bits prodsec-skills for companion files) - Fast pre-commit hooks with prek
- security-setup.md (see upstream Trail of Bits prodsec-skills for companion files) - Security hooks and dependency scanning
- dependabot.md (see upstream Trail of Bits prodsec-skills for companion files) - Automated dependency updates
